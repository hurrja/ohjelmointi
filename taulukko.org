...
** Tehtäviä
   ...
   2. Tee [[file:taulukko-varisavyt-sivu.org][tällä sivulla]] näkyvä animaatio seuraavasti. 
      ...
      - Piirtofunktiossa ~draw()~ arvo satunnainen kokonaisluku ja
        valitse taustavärin sävy käyttämällä tätä lukua taulukon
        indeksinä.
   3. Tee [[file:taulukko-ympyrat-halkaisijalla-sivu.org][tällä sivulla]] näkyvä animaatio, jossa piirtoikkunan
