...
** Tehtäviä
   1. Tee alla näkyvän kaltainen animaatio. Voit valita piirtoikkunan
      ...
      #+END_SRC
   2. Tee alla näkyvän kaltainen animaatio, jossa ikkunan taustaväri
      muuttuu viidellä yksiköllä kunkin askeleen aikana.
   ...
   3. Tee alla näkyvän kaltainen animaatio. Kokeile mitä animaatiossa
     ...
     #+END_SRC
   4. Tee alla olevan kaltaisen liikennevalot, joissa valo vaihtuu
      toiseksi viiden sekunnin välein. [Vihjeitä. Kuluneiden 5
      sekunnin jaksojen lukumäärän saat jakamalla sekuntien lukumäärän
      ...
      #+NAME: animaatio-liikennevalot-runko
      #+BEGIN_SRC processing
        int aika; // alusta kulunut aika kokonaisina sekunteina
        ...
        {
          float savy;
          int jaksot = floor (aika / 5); // kuinka monta 5s jaksoa on kulunut
