...
** Tehtävät
   1. Piirrä alla olevan kuvan mukaisesti 8 neliötä neliön muotoisen
      ...
      #+BEGIN_SRC processing
        ...
        int n = 1; // piirrettävän neliön järjestysnumero
      ...
      #+END_SRC
   2. Piirrä \(400\times 400\)-kokoisen piirtoikkunan lävistäjälle
      ...
      #+END_SRC
   3. Piirrä alla oleva kuvio ~while~-silmukan avulla piirtämällä
      ...
      #+END_SRC
   4. Alla olevassa taulukossa on Processing-lausekkeen ~n % 3~ arvoja
      eri muuttujan ~n~ arvoilla.
      #+BEGIN_CENTER
      | ~n~     | 1 | 2 | 3 | 4 | 5 | 6 | 7 |
      |---------+---+---+---+---+---+---+---|
      | ~n % 3~ | 1 | 2 | 0 | 1 | 2 | 0 | 1 |
      ...
      #+BEGIN_SRC processing
        ...
        int n = 1; // piirrettävän suorakulmion järjestysnumero

        // piirrettävän suorakulmion vasemman reunan x-koordinaatti
        float x = 0; 
      ...
      #+END_SRC
   5. Piirrä \(400\times 400\)-kokoiseen piirtoikkunaan alla oleva
