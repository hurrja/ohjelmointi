...
** Tehtävät
   1. Piirrä \(400\times 400\)-kokoisen piirtoikkunan lävistäjälle
      ...
      #+NAME: kokonaisluku-luvut-diagonaalilla
      #+BEGIN_SRC processing
        size (400, 400);
        colorMode (HSB, 100);
        background (0);
      ...
      #+END_SRC
   2. Piirrä alla oleva kuvio ~while~-silmukan avulla piirtämällä
      ...
      #+END_SRC
   3. Piirrä \(400\times 400\)-kokoiseen piirtoikkunaan alla oleva
...
** Ratkaisuja
   1. 
      #+BEGIN_SRC processing :exports code :noweb yes
      <<kokonaisluku-luvut-diagonaalilla>>
      #+END_SRC
   2. 
      #+BEGIN_SRC processing :exports code :noweb yes
