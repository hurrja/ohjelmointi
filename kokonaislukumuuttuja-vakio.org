...
** Esimerkki
   ...
   #+BEGIN_SRC processing
     ...
     for (int n = 1, x = VALI; n <= 25; n += 1, x += VALI) // turvallista vertailla, kun n on kokonaisluku
     {
...
** Tehtävät
   ...
   4. Piirrä alla oleva kuvio piirtämällä ensin suuri musta ympyrä,
      ...
      #+BEGIN_SRC processing
        ...
        for (float halkaisija = width; halkaisija > 0; halkaisija -= 10, n++)
        {
