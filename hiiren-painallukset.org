...
** Tehtäviä
   ...
   2. Kirjoita [[file:hiiren-painallukset-murtoviiva-sivu.org][tällainen]] interaktiivinen ohjelma, joka piirtää
   ...
   3. Kirjoita ohjelma, joka toteuttaa [[file:hiiren-painallukset-oskilloiva-ympyra-sivu.org][tällä sivulla]] olevan
