...
** Esimerkki
   ...
   #+END_SRC
** Tehtävät
   1. Piirrä neliön muotoiseen piirtoikkunaan alla oleva kuva, joka
      ...
      #+END_SRC
   2. Piirrä alla olevan kaltaiset kuvat /neliön muotoiseen/
	 ...
	 #+END_SRC
	  ...
	  #+END_SRC
   3. Piirrä alla olevan kaltainen kuva, joka skaalautuu piirtoikkunan
   ...
   4. 
	...
	// yhteisen kulmapisteen koordinaatit
      ...
      #+END_SRC
   5. Piirrä neliön muotoiseen ikkunaan Japanin lippu, joka skaalautuu
	...
	// punainen ympyrä
      ...
      #+END_SRC
   6. Piirrä alla oleva kuva, joka skaalautuu piirtoikkunan
      mukana. Ohjelmassa määritelty vakio ~P~ määrää, kuinka monta
...
** Ratkaisuja
   ...
   5. 
      ...
      #+END_SRC
   6. Alla on kaksi esimerkkiratkaisua tehtävään. Ensimmäisessä
