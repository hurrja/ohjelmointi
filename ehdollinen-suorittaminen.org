...
** Tehtäviä
   1. Kirjoita ohjelma, joka asettaa piirtoikkunan taustan väriksi
      ...
      tapauksessa ei tehdä mitään (eli avataan vain harmaa
      piirtoikkuna). Testaa ohjelmasi toimivuus muuttamalla vakion ~P~
      arvoa.
   2. Kirjoita ohjelma, joka piirtää neliön muotoisen piirtoikkunan
      ...
      arvoa.
   3. Kirjoita ohjelma, joka piirtää piirtoikkunan vasempaan
