...
** Funktioista kirjoittaminen
   ...
   mainitaan tyyliin ~void piirraYmpyrapari (float x, float y)~.
   #+END_QUOTE
...
** Tehtävät
   1. Alla on määritelty funktio ~piirraS()~. Kopioi koodi
      ...
      ~setup()~, jossa määritellään piirtoikkunan koko.
      #+NAME: funktio-silmat
      #+BEGIN_SRC processing :exports code
   ...
   2. Määrittele funktio 
      ...
      piirtämiseen. Neliön sivun pituus on 20. Muut arvot ja mitat
