...
** Tehtäviä
   ...
   2. Alla oleva kuva esittää eräänlaista /satunnaiskävelyä/, joka
      ...
      #+CALL: rekursio-satunnaiskavely[:noweb yes]() :results html
      ...
      #+END_SRC
   3. Kolme ensimmäistä /tribonaccin lukujonon/ lukua ovat 0, 0 ja 1,
   ...
   4. Tee rekursioon perustuva ohjelma, joka piirtää alla olevan
      \ldquo{}puun\rdquo.
      ...
      #+END_SRC
   5. Eri kokoisia shakkilautoja, joissa on vaaka- ja pystysuunnassa
      ...
      0, 1 ja 2. Kirjoita ohjelma, jolla voit piirtää vastaavia kuvia.
    
      #+CALL: rekursio-shakkilauta(0) :results html
      #+CALL: rekursio-shakkilauta(1) :results html
      #+CALL: rekursio-shakkilauta(2) :results html
** Ratkaisuja
   1. 
      #+BEGIN_SRC processing :noweb yes :exports code
      <<rekursio-pystyviivat-runko>>
   ...
   4. 
      ...
      <<rekursio-puu>>
      #+END_SRC
   5. Kuvia voidaan piirtää sijoittamalla jokin luku vakion ~JAOT~
      paikalle.
      ...
      #+BEGIN_SRC processing :var JAOT=0 :exports code
                                ...
                                boolean musta)
        {
          ...
          piirraShakkilauta (jakojaJaljella, xOikea, yOikea, p, true);
          piirraShakkilauta (jakojaJaljella, x, yOikea, p, false);
