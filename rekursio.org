...
** Rekursio
   #+BEGIN_QUOTE
   /Rekursiossa/ tehtävä ratkotaan pilkkomalla se pienempiin,
   samanlaisiin tehtäviin. Yllä olevassa esimerkissä 5 sisäkkäisen
   ympyrän piirtäminen ratkaistaan
   1. piirtämällä ensin uloin ympyrä ja sen jälkeen
   2. piirtämällä 4 sisäkkäistä ympyrää.
