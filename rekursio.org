...
** Esimerkki
   ...
   #+END_SRC
** Tehtäviä
   1. Kirjoita rekursiota käyttävä ohjelma, joka piirtää alla olevan
      kuvan. Vasemmanpuoleisen pystyviivan korkeus on 350. Kukin
      seuraavan pystyviivan korkeus on 10\thinsp{}% edellistä
      pienempi. Pystyviivojen etäisyys \(x\)-akselilla on 10 pikseliä.
   ...
   2. Alla oleva kuva esittää eräänlaista /satunnaiskävelyä/, joka
      ...
      #+END_EXAMPLE
      ja kirjoita tarvittavat rivit sen tilalle.
