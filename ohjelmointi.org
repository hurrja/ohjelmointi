...
** Väreillä piirtäminen
   Processing-ohjelmointikielessä väreillä piirtäminen tapahtuu samaan
   tapaan kuin kynällä paperille piirrettäessä: ennen piirtämistä
   valitaan, minkä värisellä kynällä piirretään.

   Processing-ohjelmointikielessä on yli 16 miljoonaa eri väristä
   \ldquo{}piirtokynää\rdquo{}. Niitä ei enää kannata kaikkia nimetä,
   vaan niihin voidaan viitata eri luvuilla. Tietty kynä voidaan
