...
** Piirtoikkunan pisteen koordinaatit <<1.1>>
   ...
   #+NAME: koordinaatisto
   #+BEGIN_SRC asymptote :file koordinaatisto.svg
     int LEVEYS = 600;
     int KORKEUS = 400;
     size (LEVEYS, KORKEUS);
     ...
     // muunnos perinteisestä koordinaatistosta Processing-koordinaatistoon
   ...
   #+RESULTS: koordinaatisto
   [[file:koordinaatisto.svg]]
...
** Kuvion suunnitteleminen
   ...
   #+BEGIN_SRC asymptote :file kolmio-nelio.svg
