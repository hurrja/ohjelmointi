...
** Kokonaislukujen jakolasku antaa kokonaisluvun
   ...
   nopeammin.
** Sisäiset \ldquo{}vakiot\rdquo{} ~width~ ja ~height~
   ...
   kokonaisluvulla antaa kokonaisluvun. Yleensä tällä ei ole suurta merkitystä
   saatuun kuvaan, koska ikkunan koko on suuri. Jos ~width~ on
   vaikkapa 455, niin ~width / 2~ antaa arvoksi 227, kun taas ~width /
   2~ antaa arvoksi 227.5. 

   Seuraavassa esimerkissä piirretään neliö piirtoikkunan
   keskelle. Piirtoikkunan keskikohta on (~widht/2.0~, ~height/2.0~)
   ...
   #+END_SRC
** Esimerkki
   Suomen, Ruotsin ja Tanskan lipussa on jonkin värinen risti toisen
   värisellä pohjalla. Alla oleva ohjelma 
* Muuttuja
* Ehdollinen suorittaminen
* ~while~-silmukka
* ~for~-silmukka
