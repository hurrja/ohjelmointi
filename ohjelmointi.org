...
* Aikataulu
  ...
  | * Kommentteja ja värejä <<txt:kommentteja-vareja>>    |       2 |
  | * Kokonaislukuvakio <<txt:kokonaislukuvakio>>         |       2 |
  | * Desimaaliluku                                       |         |
  | * Muuttuja                                            |         |
...
** Tehtävät
   ...
   3. Piirrä \((400\times 400)\)-kokoiseen piirtoikkunaan alla olevan
      ...
      #+BEGIN_SRC processing
        ...
        final int KYLKI = 120;
        final int VALI = 20;
        final int OIKEA_KOLMIO_VASEN_X = KYLKI + VALI;
      ...
      #+END_SRC
   4. Piirrä \((400\times 400)\)-kokoiseen piirtoikkunaan valkoiselle
	...
	kaikkien värien kirkkaus.
      ...
      #+BEGIN_SRC processing
        size (400, 400);
        final int SUURI_SIVU = 300;
        final int PIENI_SIVU = 90;

        final int SUURI_SAVY = 15;
        final int SAVY_MUUTOS = 30;
        final int KYLLAISYYS = 70;
        final int KIRKKAUS = 90;

        // kuvassa oikealla alhaalla olevan pienen neliön vasemman yläkulman
        // x- ja y-koordinaatti (sama luku)
        final int PIENI_YLAKULMA = SUURI_SIVU - PIENI_SIVU;
	...
	// oikean alakulman neliö
      ...
      #+END_SRC
   5. Alla olevaan piirtoikkunaan on piirretty
	...
	background (0);
      ...
      #+BEGIN_SRC processing
        size (400, 400);
        final int K = 3;
        final int LEVEYS_PIENI = 40;
        final int KORKEUS_PIENI = K * LEVEYS_PIENI;
