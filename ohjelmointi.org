...
** Esimerkki
   ...
   mittasuhteet. Esimerkiksi Suomen lippu jakautuu eri osiin
   vasemmasta yläkulmasta katsoen pystysuunnassa suhteessa \(4 : 3 :
   4\) ja vaakasuunnassa suhteessa \(5 : 3 : 10\). Alla oleva kuva
   havainnollistaa näitä mittoja.

   #+NAME: lippu-mitat
   #+BEGIN_SRC asymptote :file lippu-mitat.svg :cache yes
     size (15cm, 0);
     int YLA = 4, KESKI_PYSTY = 3, ALA = 4;
     int VASEN = 5, KESKI_LEVEYS = 3, OIKEA = 10;
   ...
   #+RESULTS[c6e4b6d261fcef6f1f63835bd657cfaf1009bad1]: lippu-mitat
   ...
   #+BEGIN_SRC processing :exports both
     ...
     final float VASEN = 5;
     final float KESKI_LEVEYS = 3;
     final float OIKEA = 10;

     // suhteet pystysuunnassa
     final float YLA = 4;
     final float KESKI_PYSTY = 3;
     final float ALA = 4;

     // taustaväri
     final float TAUSTA_SAVY = 0;
     final float TAUSTA_KYLLAISYYS = 0;
     final float TAUSTA_KIRKKAUS = 100;

     // ristin väri
     final float RISTI_SAVY = 59;
     final float RISTI_KYLLAISYYS = 81;
     final float RISTI_KIRKKAUS = 49;
