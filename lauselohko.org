...
** Tehtävät
   ...
   3. Kirjoita ohjelma, joka piirtää keskelle neliön kokoista
   ...
   4. Kirjoita ohjelma, jossa piirretään \(200\times 400\)-kokoiseen
	...
	float ylemmanKirkkaus, alemmanKirkkaus;
      ...
      #+END_SRC
   5. Kirjoita ohjelma, joka piirtää piirtoikkunaan kaksi
