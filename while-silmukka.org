...
** Tehtävät
   ...
   3. Piirrä alla oleva kuva, jonka tulee skaalautua piirtoikkunan
      koon mukana. Kunkin pystyviivan värisävy on \[
      \frac{\mathtt{x}}{\mathtt{width}}\cdot 100, \] missä ~x~ on
      pystyviivan \(x\)-koordinaatti.
